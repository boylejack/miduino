...
It a takes midi file (single track/instrument for now) and converts it in to an arduino program. Version 1.0 has been tested with single track midi files generated using Qtractor. 
